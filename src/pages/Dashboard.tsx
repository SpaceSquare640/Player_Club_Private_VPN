  ...
  return (
    <div className="space-y-6" data-testid="page-dashboard">
      <div>
        ...
        <p className="text-sm text-ink-muted">Overview of your virtual network.</p>
      </div>
      ...
      <div className="grid grid-cols-[1.618fr_1fr] gap-6" data-testid="phi-grid">
        <section className="rounded-2xl bg-surface-2 p-6 ring-1 ring-white/5">
          <h2 className="text-sm font-medium text-ink-muted">Engine</h2>
          <button
            type="button"
        ...
        <section className="rounded-2xl bg-surface-2 p-6 ring-1 ring-white/5">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li className="text-brand-cyan">● Idle</li>
            <li className="text-ink-muted">0 peers connected</li>
          </ul>
        </section>
      </div>
    </div>
